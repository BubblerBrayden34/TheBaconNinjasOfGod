...
function unityAdStartedCallback() {
    try {
        if (window.unityInstance) {
            window.unityInstance.SendMessage('PersistantObjects', 'OnWebInterstitialStarted');
        }
    }
    catch (error) {
        console.log(error);
...
function unityAdFinishedCallback(state) {
    try {
        if (window.unityInstance) {
            window.unityInstance.SendMessage('PersistantObjects', 'OnWebInterstitialEnded', state);
        }
    }
    catch (error) {
        console.log(error);
