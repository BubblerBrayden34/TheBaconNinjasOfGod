/*! Full Tilt v0.7 / http://github.com/richtr/Full-Tilt */ ! function(a) {
    function b(a) {
            ...
            this.set = function(a, b, c) {
                ...
                return function(d) {
                    var e = d.w * d.w,
                        ...
                        n = d.w * d.x + d.y * d.z,
                        o = 1e-6;
                    if (n > (.5 - o) * m) a = 2 * Math.atan2(d.y, d.w), b = h, c = 0;
                    else if ((-.5 + o) * m > n) a = -2 * Math.atan2(d.y, d.w), b = -h, c = 0;
                    else {
                        var p = e - f + j - l,
                            q = 2 * (d.w * d.z - d.x * d.y),
                            r = e - f - j + l,
